...
public class CourseDetailViewModel extends BaseViewModel {
    ...
    private List<Lesson> getFallbackLessons(String courseId, String courseTitle) {
        ...
        l1.setVideoUrl("android.resource://com.example.vietsyncmobile/raw/sample_lesson");
        l1.setOrderIndex(1);
        l1.setDuration(15);
        l1.setType("video");
        ...
        l2.setVideoUrl("android.resource://com.example.vietsyncmobile/raw/sample_lesson_2");
        l2.setOrderIndex(2);
        l2.setDuration(25);
        l2.setType("video");
        list.add(l2);
        ...
        l3.setVideoUrl("android.resource://com.example.vietsyncmobile/raw/sample_lesson");
        l3.setOrderIndex(3);
        l3.setDuration(30);
        l3.setType("video");
        list.add(l3);
        ...
        l4.setVideoUrl("android.resource://com.example.vietsyncmobile/raw/sample_lesson_2");
        l4.setOrderIndex(4);
        l4.setDuration(35);
        l4.setType("video");
        list.add(l4);
