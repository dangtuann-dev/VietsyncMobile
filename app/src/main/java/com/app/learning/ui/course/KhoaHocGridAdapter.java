...
public class KhoaHocGridAdapter extends RecyclerView.Adapter<KhoaHocGridAdapter.KhoaHocGridViewHolder> {
    ...
    public KhoaHocGridAdapter(SuKienClickKhoaHoc boLangNghe) {
    ...
    @NonNull
    @Override
    public KhoaHocGridViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_course_grid, parent, false);
        return new KhoaHocGridViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull KhoaHocGridViewHolder holder, int position) {
    ...
    public static class KhoaHocGridViewHolder extends RecyclerView.ViewHolder {
        ...
        public KhoaHocGridViewHolder(@NonNull View itemView) {
            super(itemView);
